...
void display() {
	glClearColor(0.0f, 0.0f, 0.05f, 1.0f); // Set background color to black and opaque
...
int main(int argc, char** argv) {
	...
	glutInitWindowPosition(0, 10); // Position the window's initial top-left corner
	glPointSize(3);
	for (int i = 0; i < 100; i++){
